...
describe Google::Bigquery::Network::Post do
  let(:credential) { TestCred.new }
  let(:uri_in) { Google::Bigquery::NetworkBlocker::ALLOWED_TEST_URI }
  ...
  context 'successful request' do
    before(:each) do
      Google::Bigquery::NetworkBlocker.instance.allow_post(
  ...
  context 'failed request' do
    before(:each) { Google::Bigquery::NetworkBlocker.instance.deny(uri_in) }
