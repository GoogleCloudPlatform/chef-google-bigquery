        ...
        context 'title == name' do
          ...
          context 'title == name (pass)' do
            ...
            context 'gbigquery_dataset[title0]' do
              subject do
                chef_run.find_resource(:gbigquery_dataset, 'title0')
              end
            ...
            context 'gbigquery_dataset[title1]' do
              subject do
                chef_run.find_resource(:gbigquery_dataset, 'title1')
              end
            ...
            context 'gbigquery_dataset[title2]' do
              subject do
                chef_run.find_resource(:gbigquery_dataset, 'title2')
              end
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to create(:gbigquery_dataset,
                                       'title0')
          end
          it { is_expected.to have_attributes(d_label: 'title0') }
    ...
    context 'resource exists' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to delete(:gbigquery_dataset,
                                       'title0')
          end
        end
